...
void DefaultApi::setupRoutes() {
    ...
    Routes::Delete(*router, base + "/user/:developer/app/:appId", Routes::bind(&DefaultApi::user_developer_app_app_id_delete_handler, this));
    Routes::Get(*router, base + "/user/:developer/app/:appId", Routes::bind(&DefaultApi::user_developer_app_app_id_get_handler, this));
    Routes::Put(*router, base + "/user/:developer/app/:appId", Routes::bind(&DefaultApi::user_developer_app_app_id_put_handler, this));
    ...
    Routes::Patch(*router, base + "/user/:userId", Routes::bind(&DefaultApi::user_user_id_patch_handler, this));
...
void DefaultApi::user_developer_app_app_id_delete_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    posthandler_raii ph(request, response);
    // Getting the path params
    ...
    try {
      this->user_developer_app_app_id_delete(developer, appId, response);
    } catch (nlohmann::detail::exception &e) {
        //send a 400 error
        response.send(Pistache::Http::Code::Bad_Request, e.what());
        return;
...
void DefaultApi::user_developer_app_app_id_put_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    // Getting the path params
    posthandler_raii ph(request, response);
    auto developer = request.param(":developer").as<std::string>();
    auto appId = request.param(":appId").as<int32_t>();
    ...
    try {
      nlohmann::json::parse(request.body()).get_to(inlineObject4);
      this->user_developer_app_app_id_put(developer, appId, inlineObject4, response);
    } catch (nlohmann::detail::exception &e) {
        //send a 400 error
        response.send(Pistache::Http::Code::Bad_Request, e.what());
        return;
...
void DefaultApi::user_developer_app_post_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    ...
    try {
      ...
      this->user_developer_app_post(developer, inlineObject3, response);
    } catch (nlohmann::detail::exception &e) {
        //send a 400 error
        response.send(Pistache::Http::Code::Bad_Request, e.what());
        return;
...
void DefaultApi::user_post_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    ...
    try {
      ...
      this->user_post(inlineObject1, response);
    } catch (nlohmann::detail::exception &e) {
        //send a 400 error
        response.send(Pistache::Http::Code::Bad_Request, e.what());
        return;
...
void DefaultApi::user_user_id_patch_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    posthandler_raii ph(request, response);
    // Getting the path params
    auto userId = request.param(":userId").as<std::string>();
    ...
    try {
      ...
      this->user_user_id_patch(userId, inlineObject, response);
    } catch (nlohmann::detail::exception &e) {
        //send a 400 error
        response.send(Pistache::Http::Code::Bad_Request, e.what());
        return;
...
void DefaultApi::user_user_id_questionary_app_id_post_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    ...
    try {
      nlohmann::json::parse(request.body()).get_to(inlineObject5);
      this->user_user_id_questionary_app_id_post(appId, userId, inlineObject5, response);
    } catch (nlohmann::detail::exception &e) {
        //send a 400 error
        response.send(Pistache::Http::Code::Bad_Request, e.what());
        return;
...
void DefaultApi::user_user_id_tasks_post_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response) {
    ...
    try {
      ...
      this->user_user_id_tasks_post(userId, inlineObject2, response);
    } catch (nlohmann::detail::exception &e) {
        //send a 400 error
        response.send(Pistache::Http::Code::Bad_Request, e.what());
        return;
